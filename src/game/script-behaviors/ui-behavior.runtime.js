...
export function addGenericComponent (uiContext, masterParentContext, layout) {
    const component = addGenericUIComponent(layout, uiContext.scene);
    uiContext.add(component);
    return component;
};

export function addBackground (uiContext, masterParentContext, layout) {
    uiContext.setOriginalBaseSize(addGenericComponent(uiContext, masterParentContext, layout));
};

export function addButton (uiContext, masterParentContext, layout) {
...
export function addTab (uiContext, masterParentContext, layout) {
